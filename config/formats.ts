...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: ['Uber', 'AG', 'Moody', 'Power Construct', 'Shadow Tag', 'Arena Trap', 'Swagger', 'Misty Explosion', "Dark Hole", "Centiskorch-Sevii + Centiskite-Sevii + Arena Trap", "Draco Barrage"],
	},
	{
		name: "[Gen 8] Ubers",
		mod: 'gen8rr',
